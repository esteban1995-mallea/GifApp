// To parse this data:
//
//   import { Convert, SourceGIFResponse } from "./file";
//
//   const sourceGIFResponse = Convert.toSourceGIFResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SourceGIFResponse {
    data:       Gifs[];
...
export class Convert {
    public static toSourceGIFResponse(json: string): SourceGIFResponse {
        return cast(JSON.parse(json), r("SourceGIFResponse"));
    }

    public static sourceGIFResponseToJson(value: SourceGIFResponse): string {
        return JSON.stringify(uncast(value, r("SourceGIFResponse")), null, 2);
    }
}
